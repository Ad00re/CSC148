...
from strategy import random_strategy, interactive_strategy
from typing import Any, Callable
from game import Game, Sub, Chop
...
class GameInterface:
    ...
    def __init__(self, game: Game, p1_strategy: Callable,
    ...
    def play(self) -> None:
        ...
        print(current_state) #必须有__init__

        # Pick moves until the game is over
        while not self.game.is_over(current_state):# game必须有isover
            move_to_make = None

            # Print out all of the valis
            #d moves
            possible_moves = current_state.get_possible_moves() #是一个list
